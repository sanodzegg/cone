            ...
            <div className="rounded-2xl border border-border p-5 space-y-4">
                ...
                <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                        ...
                        <p className="text-sm text-foreground tabular-nums">{dailyTokens} / {DAILY_TOKEN_LIMIT} <span className="text-muted-foreground">today</span></p>
                    </div>
            ...
            <div className="grid grid-cols-2 gap-3">
                {ENGINE_ROWS.map(({ label, engine, icon: Icon }) => (
                    <div key={label} className="flex items-center gap-2.5">
                        ...
                        <div>
                            <p className="text-base font-medium text-foreground tabular-nums">{counts[engine].toLocaleString()}</p>
